...
Este primeio capítulo foi baseado no curso on-line denominado "_Code School Try R_ e _Datacamp_". Foram realizadas modificações utilizando-se de outros materiais que se encontram referenciados no final desse capítulo.
